# ientrance-instruments

Schema and parser for iEntrance FabLIMS instruments
...
```sh
git clone https://github.com/abbasgholami71/ientrance-instruments.git
cd ientrance-instruments
